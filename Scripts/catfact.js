/**/// Description: Listens for /catfact and returns a cat fact based on those available at http://maxellah.tripod.com/catfacts.htm
/**///
/**/// Dependencies: None
/**///
...
exports.script = function(boombot, data) {
 ...
 "Some common houseplants poisonous to cats include: English Ivy, iris, mistletoe, philodendron, and yew.",
  ...
  var rndm = (Math.round((Math.random()*18)+1));
  boombot.bot.speak(catFactList[rndm]);
}